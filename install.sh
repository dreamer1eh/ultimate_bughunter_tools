...
echo "	[~] Website   : https://www.dreamereh.ml/ "
echo "	[~] Github    : https://github.com/dreamer1eh/ "
echo "	[~] YouTube   : @i_eh_dreamer {https://www.youtube.com/iehdreamer/} "
echo "	[~] Instagram : @i_eh_dreamer {https://www.instagram.com/dreamer1eh/} "
echo "	[~] Twitter   : @i_eh_dreamer {https://twitter.com/dreamer1eh/}"
